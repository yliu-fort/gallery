...
if(NVIDIA_BUILD)
set(COMPUTECPP_USER_FLAGS "-fno-addrsig" CACHE STRING "User flags for compute++" FORCE)
separate_arguments(COMPUTECPP_USER_FLAGS)
mark_as_advanced(COMPUTECPP_USER_FLAGS)

set(COMPUTECPP_BITCODE "ptx64" CACHE STRING
  "Bitcode type to use as SYCL target in compute++" FORCE)
mark_as_advanced(COMPUTECPP_BITCODE)
else()
set(COMPUTECPP_USER_FLAGS "" CACHE STRING "User flags for compute++" FORCE)
separate_arguments(COMPUTECPP_USER_FLAGS)
mark_as_advanced(COMPUTECPP_USER_FLAGS)
...
elseif(DEFINED ENV{COMPUTECPP_ROOT_DIR})
  set(computecpp_find_hint $ENV{COMPUTECPP_ROOT_DIR})
endif()
