function [RHOSTAR, USTAR, VSTAR, PSTAR] = riemann_solver_md(x, t, RHOL,UL,VL,PL,RHOR,UR,VR,PR,GAMMA)
...
%x = linspace(-1,1,201);
%t = 0.25;
%SAMPLER = @(x,t)(sample(x,t,USTAR,PSTAR,RHOL,UL,VL,PL,RHOR,UR,VR,PR,GAMMA));
%[rhom,um,pm] = arrayfun(sampler, x.');
[RHOSTAR, USTAR, VSTAR, PSTAR] = sample(x,t,USTAR,PSTAR,RHOL,UL,VL,PL,RHOR,UR,VR,PR,GAMMA);
end
...
function [rho,u, v, p] = sample(x,t,ustar,pstar,rhol,ul,vl,pl,rhor,ur,vr,pr,gamma)
